# TouchDesigner Guide — References

Pick the ONE file that matches your task. If unsure, start with @basics/index.md.

| Your task | File |
|---|---|
| Creating operators, positioning, connecting, parameters, debugging, saving data | @basics/index.md |
