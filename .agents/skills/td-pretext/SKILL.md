---
name: td-pretext
description: "Native TouchDesigner text layout, font atlas generation, GPU-instanced text rendering, obstacle avoidance, and porting Pretext.js patterns to pure TD. Use when the user needs text flowing around circles, bitmap silhouettes, or arbitrary shapes, character-level 60fps layout, atlas metrics, glyph CHOP data, GLSL MAT text rendering, Web Render TOP input latency comparisons, or mentions TDpretext native text."
---
